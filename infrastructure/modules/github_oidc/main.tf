...
# GitHub Actions OIDC Identity Provider & Role
# ──────────────────────────────────────────────────────────────
...
# Define the assume role policy strictly for the main branch of the repository
...
# Attach inline policy to the role granting ECR, ECS, and PassRole permissions
